            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="px-2 badge bg-warning" href="/dashboard/posts/{{ $post->slug }}/edit"><span data-feather="edit-3"></span></a>
                        <form class="d-inline" action="/dashboard/posts/{{ $post->slug }}" method="POST">
                            @method('delete')
                            @csrf
                            <button class="px-2 badge bg-danger border-0" type="submit" onclick="return confirm('delete?');"><span  data-feather='trash-2'></span></button>
                        </form>
